"""
Slightly altered version of setup.py for run_ppdisk_fargo3d_1

Changes:
- uses radially symmetric density profile extracted from a fargo3d simulation. (We take the azimuthal average to obtain the density profile)
- Only one dust species with very small particles; well mixed with gas (as opposed to 4(?) dust species that could also settle)

I also looked at the code in detail and tried to understand most of it.
"""
#for reading a 2-D (r,phi) model from FARGO3D with dust
# into RADMC-3D.
#
import numpy as np
